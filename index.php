    ...
    <footer class="page-footer">
      ...
      <div class="footer-nav">
        <div class="container clearfix">
          ...
          <div class="footer-nav__col footer-nav__col--contacts">
            ...
            Head Office: Rival Store.<br>
            180-182 Bekasi, Indonesia.
          </address>
            <div class="phone">
              Telephone:
              <a class="phone__number" href="tel:0123456789">089501443935</a>
            </div>
            <div class="email">
              Email:
              <a href="mailto:RivalStore@gmail.com" class="email__addr">RivalStore@gmail.com</a>
            </div>
          </div>
      ...
      <div class="page-footer__subline">
        <div class="container clearfix">
          ...
          <div class="copyright">
            &copy; <?php echo date("Y");?> Rival Store&trade;
          </div>
